    ...
    private class LongOperation  extends AsyncTask<String, Void, String> {
        ...
        protected void onPostExecute(String result) {
            ...
            try {
                ...
                div.setText(jsonResponse.getString("Division"));


                JSONArray array = jsonResponse.optJSONArray("roster");
                for (int i = 0; i < array.length(); i++) {

                    JSONObject row = array.getJSONObject(i);

                    String name = row.optString("name").toString();
                    String positon = row.optString("position").toString();
                    String weight = row.optString("weight").toString();
